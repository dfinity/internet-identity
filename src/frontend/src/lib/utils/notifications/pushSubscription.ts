...
//
// The subscription's own p256dh and auth keys are deliberately ignored: they
// exist to encrypt an RFC 8291 payload, and the push carries no body.
...
export const subscribeToPush = async (
  ...
  // `userVisibleOnly` is mandatory in every browser that implements this, and
  // is what obliges the worker to show something for each push.
