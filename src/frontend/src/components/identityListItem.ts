export const identityListItem = (alias) => `<span>${alias}</span>
<button title="Remove identity"><svg id="icon_close" data-name="icon/close" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
