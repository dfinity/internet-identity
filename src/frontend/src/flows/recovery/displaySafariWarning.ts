...
const pageContent = () =>
  mainWindow({
    showLogo: false,
    showFooter: false,
    slot: html` <article id="warningContainer">
      ${warnBox({
        title: "Warning",
        ...
        slot: html`
          <p class="t-paragraph">
            ...
            This means that you will no longer have access to your identity
            anchor (and all associated resources and tokens) with this device.
          </p>
          <p class="t-paragraph">
