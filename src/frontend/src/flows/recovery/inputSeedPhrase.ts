    ...
    inputSeedPhraseContinue.onclick = async () => {
      ...
      if (validate(inputValue)) {
        ...
        await displayError({
          ...
          message:
              html`<span>This is not a seed phrase generated by Internet Identity, please make sure to copy the full seedphrase and try again. For more information, please see <a href="/faq#${questions.invalidSeedphrase.anchor}">${questions.invalidSeedphrase.question}</a></span>`,
