...
export const warningMessage = (
  ...
  switch (warning.type) {
    ...
    case "bad_anchor": {
      return html`Recovering anchor <strong class="t-strong">${userNumber}</strong>, but recovery
        phrase suggests anchor <strong class="t-strong">${warning.anchor}</strong>`;
    }
    ...
    case "invalid": {
      return html`
        ...
        <a target="_blank" class="t-link" href="/faq#${questions.invalidSeedphrase.anchor}"
