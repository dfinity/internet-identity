...
/// destructures the §3.6 headers into typed fields of
/// `unverified::SmtpMessage`. That's where the duplicate/missing
/// checks land — not here — so this validator stays focused on bounds
/// alone.
