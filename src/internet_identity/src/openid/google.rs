...
use internet_identity_interface::internet_identity::types::{GoogleOpenIdConfig, MetadataEntryV2};
...
impl Provider {
    pub fn create(config: GoogleOpenIdConfig) -> Provider {
        #[cfg(test)]
...
fn should_return_credential() {
    ...
    let provider = Provider::create(GoogleOpenIdConfig {
