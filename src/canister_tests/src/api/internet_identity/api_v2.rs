...
use internet_identity_interface::internet_identity::types::{
    AuthnMethodAddResponse, AuthnMethodData, IdentityInfoResponse, IdentityMetadataWriteResponse,
...
) -> Result<Option<IdentityMetadataWriteResponse>, CallError> {
    call_candid_as(
        env,
        canister_id,
        sender,
        "identity_metadata_write",
