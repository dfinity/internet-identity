...
```json
{
  "canisters": {
    "internet_identity": {
      "type": "custom",
      "candid": "https://github.com/dfinity/internet-identity/releases/download/lm-update-readme-to-latest-release/internet_identity.did",
      "wasm": "https://github.com/dfinity/internet-identity/releases/download/lm-update-readme-to-latest-release/internet_identity_dev.wasm.gz",
