...
Write a proposal description like those in

https://github.com/dfinity/nns-proposals/blob/main/proposals/identity/
...
[source,bash]
----
dfx canister --network mainnet --no-wallet info idp_service
----
