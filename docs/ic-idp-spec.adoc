...
----
npm install
dfx build --network mainnet idp_service
----

Note: This prepares the wasm module for installation on `mainnet`. If we want to deploy to testnet, then you can use `messaging` or add a new profile for the testnet in dfx.json.
