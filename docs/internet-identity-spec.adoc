...
This method, if called with a valid verification code, adds the tentative device to the user permanently and exits registration mode.
...
Fetches all data associated with a user including registration mode and tentatively registered devices.
