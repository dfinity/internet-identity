...
A few terms, because the rest of this page and the three designs use them.
...
The three designs are not independent. Account tracking has to land first: it supplies the
