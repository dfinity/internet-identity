...
| Idle bound              | 7 days where the app asks for none  | the app may request one, II defaults, clamps and enforces                              | how long a session outlives its use, before II ends it              |
