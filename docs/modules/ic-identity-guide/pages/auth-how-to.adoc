...
+
NOTE: On OSX (including iPhones), TouchId authentication on Safari is coupled to your browser profile. If you want to log in with other browsers as well, or if you use multiple Safari browser profiles, you have to add them as a new device (see below).
