...
- `name` must not exceed 40 characters and `description` must not exceed 120 characters (counted in Unicode code points, after whitespace normalization). Control characters and bidirectional-override characters are stripped.
